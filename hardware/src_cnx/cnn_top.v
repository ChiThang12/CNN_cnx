...
module cnn_top(
  ...
  wire [575:0] w_cache_flat;   // 72 bytes = 72*8 bits weight cache
  wire [255:0] pe_out_flat;    // 8 PEs * 32-bit outputs
  wire [255:0] psum_in_flat;   // 8 PEs * 32-bit partial sums

  wire [4:0]  bits_select;
  wire [31:0] BRAM_IF2_ADDR_temp;
  wire [31:0] L2_BRAM_IF1_ADDR_temp;
  ...
  // ===========================================================
  assign relu_en = (layer == 3'd1) || (layer == 3'd2) || (layer == 3'd3);
